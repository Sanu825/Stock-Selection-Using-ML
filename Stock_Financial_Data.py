...
tickers = ['AFFLE.NS', 'BSOFT.NS', 'CAMS.NS', 'CMSINFO.NS', 'COFORGE.NS', 'CYIENT.NS', 'ECLERX.NS', 'FSL.NS', 'HAPPSTMNDS.NS', 'HCLTECH.NS', 'INFY.NS', 'INTELLECT.NS', 'KPITTECH.NS', 'LTIM.NS', 'LTTS.NS', 'MASTEK.NS', 'MPHASIS.NS', 'NAUKRI.NS', 'NEWGEN.NS', 'OFSS.NS', 'PERSISTENT.NS', 'RATEGAIN.NS', 'ROUTE.NS', 'SONATSOFTW.NS', 'TANLA.NS', 'TATAELXSI.NS', 'TCS.NS', 'TECHM.NS', 'TEJASNET.NS', 'WIPRO.NS', 'ZENSARTECH.NS', 'ZENTEC.NS']
